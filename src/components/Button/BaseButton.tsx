 ...
 */
export const BaseButton = memo<IconTextButton | IconOnlyButtonProps>(
  ({
    size = 'base',
    shape = 'square',
    loading = false,
    ...
    return (
      <ButtonContainer {...{ size, variant, shape, disabled, loading, iconOnly, style }} {...props}>
        <ButtonLeftArea {...{ size, variant, loading, disabled, Icon, iconPosition }} />
        <ButtonLabel {...{ size, variant, loading, disabled, iconOnly, label }} />
        <ButtonRightArea {...{ size, variant, loading, disabled, Icon, iconPosition }} />
      </ButtonContainer>
    )
  }
)
