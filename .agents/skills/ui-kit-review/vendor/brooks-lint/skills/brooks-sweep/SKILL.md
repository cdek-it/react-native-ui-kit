...
name: brooks-sweep
description: >
  Analyze and apply codebase-wide quality fixes across architecture, technical
  debt, production code, and tests. Use only when the user requests both a
  whole-project diagnosis and modifications.
---
